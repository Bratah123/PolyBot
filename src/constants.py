...
JOBS = [
    ...
    "The school was at fault for trying to make me memorise stupid stuff rather than stimulating me",
...
WOZNIAK = [
    ...
    "It's a lot easier to think of an app and write it, than it is to convince people to want it, publicity is crucially important. Marketing is the most important thing.",
    ...
    "What Steve Jobs and I did, and at the same time Bill Gates and Paul Allen did – we had no savings accounts, no friends that could loan us money, but we had ideas, and I wanted all my life to be part of a revolution.",
]
